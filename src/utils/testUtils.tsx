...
export const log = async (body: HTMLElement = document.body.parentElement as HTMLElement, options?: waitForOptions) => {
...
export const renderWithRouter = ({ router = '/' } = {}) => {
  window.history.pushState({}, 'Test register', router)
  return {
